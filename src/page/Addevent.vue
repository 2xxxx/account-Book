<template>
  <div class="add_event">
    ...
    <cube-input type="text" id="add" @keyup.enter="add(addItem)" @focus="show()" v-model="addItem"></cube-input>
    <span class="tip" v-show="flag">不能为空</span>
    <br>
    <!-- <img class="cal" src="http://localhost:8000/assets/image/cal.png" alt=""> -->
...
export default {
  ...
  methods:{
    add(addItem){
      ...
      var item={sort:addItem,imgSrc:'http://localhost:8000/assets/image/star.png'};
