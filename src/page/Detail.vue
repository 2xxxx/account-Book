<template>
    <div class="detail">
        ...
        <span>￥</span>
        <span>备注</span>   
        <ul class='big_menu' v-for='(item,index) in newDate' :key="index">
            <li>
                <span v-text='item.sign'></span>
            </li>
            <li>
                <input v-model='item.cost' readonly='true'/>>元
            </li>
            <li>
                <input v-model='item.remark' readonly='true'/>
                <div v-if="item.isShow">
                    <i class="cubeic-ok" @click="overListItem(index)"></i>
                    <i class="cubeic-close" @click="cancelListItem(index)"></i>
                  
                </div>
                <div v-else>
                    <i class="icon iconfont iconbianji" @click="changeListItem(index)"></i>
                    <i class="icon iconfont iconshanchu" @click="delListItem(index)"></i>
                </div>              
            </li>
        </ul>
